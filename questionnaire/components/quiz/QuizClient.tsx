...
const questions: Question[] = [
  { id: 1, question: "On what date and at what time is the suspicious email received? [Format: dd.mm|HH:MM:SS]" },
  { id: 2, question: "What is the sender address of the suspicious email? [Format: email@domain.tld]" },
  { id: 3, question: "Who is the targeted user, and what is the IP of their workstation? [Format: user|A.B.C.D]" },
  { id: 4, question: "Which MITRE ATT&CK sub-technique does this activity map to? [Format: Txxxx.x—Name]" },
  { id: 5, question: "What is the clicked URL, and what IP address did it resolve to? [Format: URL|A.B.C.D]" },
  ...
  { id: 8, question: "What is the SSH session ID? [Format: exact session/token string]" },
  ...
  { id: 11, question: "How many services are exposed, and on which IP is the Ollama runtime hosted? [Format: no. services|A.B.C.D]" },
  { id: 12, question: "What is the domain name corresponding to the IP 172.18.0.5? [Format: FQDN]" },
  { id: 13, question: "How many API endpoints are exposed? [Format: Number]" },
  { id: 14, question: "Which API endpoint is attacked? [Format: /path]" },
  { id: 15, question: "How many commands are executed in total during the attacker’s session? [Format: Number]" },
  ...
  { id: 18, question: "Which fake Python library is recommended by the LLM as a result of the poisoning? [Format: package-name]" },
  { id: 19, question: "By which user is the malicious library downloaded? [Format: username]" },
  { id: 20, question: "What mechanism is implemented inside the fake library? [Format: mechanism_name]" },
  { id: 21, question: "In which file is the reverse shell code located? [Format: filename]" },
